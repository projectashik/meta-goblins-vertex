...
const Register = () => {
  ...
  return (
    <form onSubmit={form.onSubmit(handleSubmit)}>
      <Paper className='space-y-3'>
        <Radio.Group withAsterisk {...form.getInputProps("type")} name='role'>
          <Radio value='edible' label='Non Profit' />
          <Radio value='non_edible' label='Manufacturer' />
        </Radio.Group>
        <TextInput
          withAsterisk
        ...
        <TextInput
          ...
          rightSection={
            <Tooltip label='Send OTP'>
              <ActionIcon onClick={sendOtp} loading={otpLoading}>
                <IconSend width='15px' height='15px' />
              </ActionIcon>
            </Tooltip>
          }
        ...
        <Button type='submit' loading={loading} size='md' color='dark'>
          Register
        </Button>
      </Paper>
    </form>
